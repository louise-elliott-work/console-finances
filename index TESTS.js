...
//String finances array to facilitate future calculations
var financesString = finances.toString();
//console.log(financesString);
...
var concatArray2 = [].concat(...financesString)
...
//New array with months too

console.log("All monthly changes: " + allMonthlyChanges);

var maxChange = Math.max(...allMonthlyChanges);
var maxChangeMonth;
console.log("Greatest Increase in Profits: " + maxChangeMonth + "($" + maxChange + ")");

var minChange = Math.min(...allMonthlyChanges);
var minChangeMonth;
console.log("Greatest Decrease in Profits: " + minChangeMonth + "($" + minChange + ")");
